...
export default async function POST(req: NextApiRequest) {
  ...
  const myPrompt =
    'You are a Blender script interpreter. Please describe the artistic and functional aspects of the following Python code. Provide an originality index by comparing it to the existing Blender Python code at the end.';
