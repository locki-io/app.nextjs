...
export const HeaderComponent: React.FC<HeaderProps> = (props: HeaderProps) => {
  const { pageTitle, subTitle, isAnimated, hasImage, animation, pageSubtitle, dataNftCount, children } = props;
  return (
    <div className="flex justify-center py-4">
      <div className="flex flex-col w-full">
        ...
        <div>
          ...
          <div className="flex flex-wrap base:flex-row justify-center md:justify-normal gap-x-8 ">{children}</div>
        </div>
      </div>
    </div>
  );
